    ...
    return (
        ...
        <div 
            ...
            <form className="flex flex-col" action="#">
                ...
                type="text" name="first_name" placeholder="First name" defaultValue={editMember.first_name} required />
                <input 
                className="bg-gray-300 rounded p-1 my-2 hover:bg-gray-400"
                type="text" name="first_name" placeholder="Last name" defaultValue={editMember.last_name} required />
                <input 
                className="bg-gray-300 rounded p-1 my-2 hover:bg-gray-400"
                type="email" name="email" placeholder="email@hotmail.com" defaultValue={editMember.email} required />
                <input 
                className="bg-gray-300 rounded p-1 my-2 hover:bg-gray-400"
                type="tel" name="phone" placeholder="123 456 7890" defaultValue={editMember.phone} required />
                <div className="flex">
                ...
                <div>
                    ...
                    type="date" min="1920-01-01" max="2015-01-01" name="dob" 
                    defaultValue={editMember.dob} required />
                </div>
                <input 
                className="bg-gray-300 rounded p-1 my-2 hover:bg-gray-400"
                type="text" name="address" placeholder="123 address Ave" defaultValue={editMember.address} required />
                <input 
                className="bg-gray-300 rounded p-1 my-2 hover:bg-gray-400"
                type="url" name="media" placeholder="URL Image" defaultValue={editMember.media} required />
                <button 
                    onClick={() => {}}
