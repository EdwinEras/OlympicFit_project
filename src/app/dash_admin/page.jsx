...
export default function DashAdmin() {
  const arrClasses = [
    {
      id: 1,
      name: "Yoga 1",
      description: "this is the description for Yoga 1",
      active: "yes",
      start_time: "2025-05-01T00:00",
      end_time: "2025-08-01T00:00",
      category: "Regular",
      capacity: 10,
      location: "In person",
    ...
    },
    {
      id: 2,
      name: "Zumba 1",
      description: "this is the description for Zumba 1",
      active: "no",
      start_time: "2025-05-01T00:00",
      end_time: "2025-08-01T00:00",
      category: "Intermedia",
    ...
    },
    {
      id: 3,
      name: "Cardio 1",
      description: "this is the description for Cardio 1",
      active: "yes",
      start_time: "2025-05-01T00:00",
      end_time: "2025-08-01T00:00",
      category: "Advance",
  ...
  const arrTrainers = [
    ...
    },
    {
      ...
      last_name: "Jhon",
      dob: "1980-03-25",
      email: "eltonjhon@hotmail.com",
      phone: "1234567890",
      password: "mypassword",
      gender: "other",
      employee_type: "Cardio",
      employment_status: "active",
      salary: 3000.5,
      hour_rate: 8,
      media: "http://example.com",
